...
type MetricsContext struct {
	// Enable or Disable receiving of statistics events
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// Interval to receive events in
...
func (m *MetricsContext) Reset()         { *m = MetricsContext{} }
func (m *MetricsContext) String() string { return proto.CompactTextString(m) }
func (*MetricsContext) ProtoMessage()    {}
func (*MetricsContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_c30b3f1555e8b686, []int{8}
}

func (m *MetricsContext) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MetricsContext.Unmarshal(m, b)
}
func (m *MetricsContext) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MetricsContext.Marshal(b, m, deterministic)
}
func (m *MetricsContext) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetricsContext.Merge(m, src)
}
func (m *MetricsContext) XXX_Size() int {
	return xxx_messageInfo_MetricsContext.Size(m)
}
func (m *MetricsContext) XXX_DiscardUnknown() {
	xxx_messageInfo_MetricsContext.DiscardUnknown(m)
}

var xxx_messageInfo_MetricsContext proto.InternalMessageInfo

func (m *MetricsContext) GetEnabled() bool {
	if m != nil {
		return m.Enabled
	}
	return false
...
func (m *MetricsContext) GetInterval() int64 {
	if m != nil {
		return m.Interval
	}
	return 0
...
type ConnectionContext struct {
	...
	MetricsContext       *MetricsContext  `protobuf:"bytes,4,opt,name=metrics_context,json=metricsContext,proto3" json:"metrics_context,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ConnectionContext) GetMetricsContext() *MetricsContext {
	if m != nil {
		return m.MetricsContext
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*MetricsContext)(nil), "connectioncontext.MetricsContext")
...
var fileDescriptor_c30b3f1555e8b686 = []byte{
	...
	,
}
