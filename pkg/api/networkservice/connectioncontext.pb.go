...
type IPContext struct {
	...
	SrcIpAddr          []string              `protobuf:"bytes,1,rep,name=src_ip_addr,json=srcIpAddr,proto3" json:"src_ip_addr,omitempty"`                            // source ip address + prefix in format <address>/<prefix>
	DstIpAddr          []string              `protobuf:"bytes,2,rep,name=dst_ip_addr,json=dstIpAddr,proto3" json:"dst_ip_addr,omitempty"`                            // destination ip address + prefix in format <address>/<prefix>
...
var file_connectioncontext_proto_rawDesc = []byte{
	...
	0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x73, 0x72, 0x63, 0x49, 0x70, 0x41, 0x64,
	0x64, 0x72, 0x12, 0x1e, 0x0a, 0x0b, 0x64, 0x73, 0x74, 0x5f, 0x69, 0x70, 0x5f, 0x61, 0x64, 0x64,
	0x72, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x64, 0x73, 0x74, 0x49, 0x70, 0x41, 0x64,
