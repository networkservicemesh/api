...
type NetworkServiceEndpoint struct {
	...
	Labels             map[string]*NetworkServiceLabels `protobuf:"bytes,3,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *NetworkServiceEndpoint) GetLabels() map[string]*NetworkServiceLabels {
	if m != nil {
		return m.Labels
	}
	return nil
...
type NetworkServiceList struct {
	List                 []*NetworkService `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *NetworkServiceList) Reset()         { *m = NetworkServiceList{} }
func (m *NetworkServiceList) String() string { return proto.CompactTextString(m) }
func (*NetworkServiceList) ProtoMessage()    {}
func (*NetworkServiceList) Descriptor() ([]byte, []int) {
	return fileDescriptor_41af05d40a615591, []int{7}
}

func (m *NetworkServiceList) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NetworkServiceList.Unmarshal(m, b)
}
func (m *NetworkServiceList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NetworkServiceList.Marshal(b, m, deterministic)
}
func (m *NetworkServiceList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NetworkServiceList.Merge(m, src)
}
func (m *NetworkServiceList) XXX_Size() int {
	return xxx_messageInfo_NetworkServiceList.Size(m)
}
func (m *NetworkServiceList) XXX_DiscardUnknown() {
	xxx_messageInfo_NetworkServiceList.DiscardUnknown(m)
}

var xxx_messageInfo_NetworkServiceList proto.InternalMessageInfo

func (m *NetworkServiceList) GetList() []*NetworkService {
	if m != nil {
		return m.List
	}
	return nil
...
type NetworkServiceEndpointList struct {
	List                 []*NetworkServiceEndpoint `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *NetworkServiceEndpointList) GetList() []*NetworkServiceEndpoint {
	if m != nil {
		return m.List
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*NetworkServiceLabels)(nil), "registry.NetworkServiceEndpoint.LabelsEntry")
	...
	proto.RegisterType((*NetworkServiceList)(nil), "registry.NetworkServiceList")
...
var fileDescriptor_41af05d40a615591 = []byte{
	...
	,
}
...
type NetworkServiceEndpointRegistry_FindClient interface {
	Recv() (*NetworkServiceEndpointList, error)
	grpc.ClientStream
}
...
func (x *networkServiceEndpointRegistryFindClient) Recv() (*NetworkServiceEndpointList, error) {
	m := new(NetworkServiceEndpointList)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type NetworkServiceEndpointRegistry_FindServer interface {
	Send(*NetworkServiceEndpointList) error
	grpc.ServerStream
}
...
func (x *networkServiceEndpointRegistryFindServer) Send(m *NetworkServiceEndpointList) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *networkServiceRegistryFindClient) Recv() (*NetworkServiceList, error) {
	m := new(NetworkServiceList)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (x *networkServiceRegistryFindServer) Send(m *NetworkServiceList) error {
	return x.ServerStream.SendMsg(m)
}
